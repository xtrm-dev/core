 ...
 *
 * Lane 2: beads segment removed. Pure git reader — path/branch, context
 * usage, provider/model/thinking. Git-only footer; no beads segment renders.
 */
...
// Lane 2 (hook cleanup): the retired beads-status-cache.mjs payload is deleted.
// The footer is git-only; no beads cache module is ever loaded.
		...
		ctx.ui.setFooter((tui: any, theme: any, footerData: any) => {
			...
			return {
				...
				render(width: number): string[] {
					...
					// Lane 2: git-only footer — the retired beads payload is deleted.
					const beadsDisplay = "";
