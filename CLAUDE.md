...
This project is indexed by GitNexus as **xtrm-tools** (12477 symbols, 17941 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
