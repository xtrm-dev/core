...
This project is indexed by GitNexus as **xtrm-tools** (5938 symbols, 9278 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
