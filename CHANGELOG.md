...
### Added
- Add Specialists advanced optional pack ([1e5aee6](https://github.com/xtrm-dev/core/commit/1e5aee6d70aa6a5731de85344f5b8a2fdbdeafb3))
- Add deterministic change provenance helper ([0e65547](https://github.com/xtrm-dev/core/commit/0e655477f891eb8bc1c6cf72c8ae9db61dca8a97))
- Skillbridge — mount python-backed skills as importable kernel modules (xtrm-h7uwi.1) ([309295a](https://github.com/xtrm-dev/core/commit/309295a42b0819c23d70ad4fefdf84ae49f25878))
- Python-kernel QoL — stdlib prelude + output truncation with shape hint (xtrm-h7uwi.2) ([8a16fa4](https://github.com/xtrm-dev/core/commit/8a16fa400275a1a2aec791ff7c6c94cdce05f74d))
- Python-kernel audit seam — kernel mutation events visible to host (xtrm-h7uwi.3) ([650f8bd](https://github.com/xtrm-dev/core/commit/650f8bd4776edea88af073afba20dde1ef52709f))
- Service-knowledge ext v1 — self-gating registration + drift notice (xtrm-6z6.1) ([b082a86](https://github.com/xtrm-dev/core/commit/b082a861ffc1fefa3229038ac8af02b315019dad))
- Service_knowledge in-kernel binding (xtrm-6z6.4) ([3c502ee](https://github.com/xtrm-dev/core/commit/3c502ee59c7a219be93c91b4d532f3dc0ed43540))
- Python-kernel preflight — file-scoped memory retrieval prelude ([952a1bc](https://github.com/xtrm-dev/core/commit/952a1bc5fadde3178184b5d6aee62ef2ba6ed752))
- Manage approved XTRM package baseline ([52b7e00](https://github.com/xtrm-dev/core/commit/52b7e00b4706db8df90a98bb1315bd061148dce8))
- Define durable execution identity lifecycle ([11c5230](https://github.com/xtrm-dev/core/commit/11c523002ace16866975b063ec75daeb62d8fb31))
- Add durable work lifecycle facade ([7d2d91a](https://github.com/xtrm-dev/core/commit/7d2d91a11c338d54c0bcee15b579019b28fae4f3))
- Register durable work lifecycle command ([d7d87bb](https://github.com/xtrm-dev/core/commit/d7d87bbb072166e4d9b8ad0d3887173d6669bd59))
- Route claim gate remediation through xt work ([7d2cc93](https://github.com/xtrm-dev/core/commit/7d2cc93f4d6f61cf4a7fe36b602bfd012639c454))
- Guide blocked edits through xt work ([d65b82b](https://github.com/xtrm-dev/core/commit/d65b82b554d0c44ba50093730b6495f0483ba92d))
- ISSUE-136 Phase A — targeted session-start, Service Knowledge routing (xtrm-dkvrz) ([9ca608c](https://github.com/xtrm-dev/core/commit/9ca608cd191e3ca873de6beb84cb49961b5562db))
- ISSUE-136 shared canonical contract + AGENTS/CLAUDE parity (xtrm-5c0ug) ([415fdc5](https://github.com/xtrm-dev/core/commit/415fdc5094b9ae79f09626f88a7cf1b4c0566264))
- ISSUE-136 c.12969 — compact common contract (126→29-line body) ([b330c4e](https://github.com/xtrm-dev/core/commit/b330c4e0123edef629cd32848bb903da1669bd5f))
- Python-kernel preflight — file-scoped memory retrieval prelude (#611) ([e6124b7](https://github.com/xtrm-dev/core/commit/e6124b7829de58805f0c46b88f4a417b77503381))
- Promote multiplexing-native-test to first-class in multiplexing (#627) ([c6ee477](https://github.com/xtrm-dev/core/commit/c6ee477524394b1024f0f7c10d0c897f5a3ade2f))
- Footer section-registration seam for fleet (unitAI-beqby.2) ([ddbc76e](https://github.com/xtrm-dev/core/commit/ddbc76edac8e145146d9881dac1f3789aafe6915))
- Add managed Exa MCP baseline (#636) ([d336b0e](https://github.com/xtrm-dev/core/commit/d336b0e9fda89af35f3940e0e8b974580c3c140c))
- Vendor goal-prompt default skill (xtrm-xrmxw) (#647) ([904d6f3](https://github.com/xtrm-dev/core/commit/904d6f37a44e58b3f71fbe46097d49c6dff52be4))
- Consume Substrate-native init and enrollment lifecycle (xtrm-6qu.8) ([f949b33](https://github.com/xtrm-dev/core/commit/f949b33ff0b1f036f8f8359558e3a15ca17f2702))
...
- Verify Specialists vendoring at declared destinations ([f9174c8](https://github.com/xtrm-dev/core/commit/f9174c88b0d53246bd20657cc00b9feaddf35286))
- Check Specialists parity across default and optional placements ([18fb384](https://github.com/xtrm-dev/core/commit/18fb384c63ab38ff03fd6dd3e6802473dcfb06a7))
- Verify vendored Specialists by Git blob identity ([06378a0](https://github.com/xtrm-dev/core/commit/06378a0727fdf6c09b50e4363d577e08bee93926))
- Compare Specialists vendoring using native Git object identity ([a2f010c](https://github.com/xtrm-dev/core/commit/a2f010cfdf9d8241587d7925237402d9a5833d6c))
- Detect legacy service-skills drift marker (xtrm-6z6.2) ([e6ea8d0](https://github.com/xtrm-dev/core/commit/e6ea8d08ac19746288e1338cbe411f9e1931f37c))
- Pin and update gitleaks actions ([125e308](https://github.com/xtrm-dev/core/commit/125e308dd6011290ebe908a1f439b733d8e8a27f))
- Pin checkout in semgrep template ([b616fd0](https://github.com/xtrm-dev/core/commit/b616fd078463a24ff513d3d102c66730aee19063))
- Pin current osv actions ([7fcf3bc](https://github.com/xtrm-dev/core/commit/7fcf3bc56856d1972987d68f5f00de6488aebe5f))
- Mirror kpi prose from specialists ([0477306](https://github.com/xtrm-dev/core/commit/0477306b7afda63ae37b8d2378da0ad67100a779))
- Align Specialists ownership pin with squashed source ([e736868](https://github.com/xtrm-dev/core/commit/e7368681167ed2116e9f40d8c87a3e2843291228))
- Align Specialists release pin with squashed source ([12be02d](https://github.com/xtrm-dev/core/commit/12be02d24b0bbbcdd6635ff1f97cd2ccadc29eb8))
- Allowlist gitleaks false positives in prose and beads exports ([33ce847](https://github.com/xtrm-dev/core/commit/33ce84741732a1de2add1c6a12f1eb58f6cf746e))
- Resolve asset-contract mirrors from ownership placements ([26c0a72](https://github.com/xtrm-dev/core/commit/26c0a7206d86386f513b1a3997060b86b9c49924))
- Keep lifecycle registry and root budget gates green ([c641f57](https://github.com/xtrm-dev/core/commit/c641f5796cb8ee8dc6a95bffec8ce60cf08a7433))
- Emit stable receipts and claim before relations ([4ad4ad3](https://github.com/xtrm-dev/core/commit/4ad4ad316907ceb8ff7b038d92f665965820e1de))
- Sync xt work receipts into Claude session gates ([eee3c82](https://github.com/xtrm-dev/core/commit/eee3c8213612d4670432f34e1138cef07836f180))
- Bind xt work lifecycle to session claim and memory gates ([80fcd29](https://github.com/xtrm-dev/core/commit/80fcd2939c9385a69c7d3c2ca5db63bb877a970c))
- Enforce exact default root budget allowlist ([8cb827e](https://github.com/xtrm-dev/core/commit/8cb827e6400afc9ab130b126c77bd703b3cb0912))
- Make post-init guidance targeted and v4-aware ([29376a9](https://github.com/xtrm-dev/core/commit/29376a9869bb0a880ca5fc5710c57f649b91b946))
- Revert specialists-owned files to upstream state (xtrm-dkvrz) ([58b53e9](https://github.com/xtrm-dev/core/commit/58b53e980acd4b5881a65691aaa4acb028cd845a))
- ISSUE-136 c.12937 — reword bd-prime rule-conflict paragraph, drop fleet-dangling XTRM-GUIDE.md pointer ([da468c0](https://github.com/xtrm-dev/core/commit/da468c01c06f3e4b71d095416df1679153e0362f))
- Use actual Specialists manifest schema ([e6fd057](https://github.com/xtrm-dev/core/commit/e6fd0578c33dfe6063a608017d54907c3e761eff))
- Repin canonical provenance files by exact SHA ([68dfdce](https://github.com/xtrm-dev/core/commit/68dfdcea4e7a98fe2f87c3d731b859e0777720f5))
- Exclude one-shot finalizer from stale-pin audit ([9fa50d0](https://github.com/xtrm-dev/core/commit/9fa50d0ea50588696aaac7fe083e0ad4aa6526c6))
- Expose canonical Specialists vendor alias ([a7ac464](https://github.com/xtrm-dev/core/commit/a7ac464a0fcd5e11855f9bc81df265f5a14498e0))
- Make Core v4 finalizer deterministic ([acab1ff](https://github.com/xtrm-dev/core/commit/acab1ff6fd151748587978b8d0a02af49d86b8e8))
- Run header injector through CommonJS bundle ([3d2426b](https://github.com/xtrm-dev/core/commit/3d2426b9d55fca51a378e17e96117345988885bb))
- Run header injector from package-relative bundle ([7c12cad](https://github.com/xtrm-dev/core/commit/7c12cad754b07e96ec4699a5847b53d7626607db))
- Separate generated commit from workflow cleanup ([47be887](https://github.com/xtrm-dev/core/commit/47be88715723d2c98c47b0af060472da0b8c8dce))
- Finalize Core v4 distribution ([18e2ae1](https://github.com/xtrm-dev/core/commit/18e2ae1a0c959e47d73dc90227bec105b3276ee5))
- Preserve stable Specialists repo path on vendoring ([589e67e](https://github.com/xtrm-dev/core/commit/589e67e528ca07ef2ee2be869d6f0361369fe50b))
- Normalize durable Specialists source path ([433c814](https://github.com/xtrm-dev/core/commit/433c8147f17ddc1b9d8f8a436377eb0cf7accaef))
- Finalize Core v4 distribution ([7ef95d3](https://github.com/xtrm-dev/core/commit/7ef95d317c56d22dde9fd1f95f19ef62ac163955))
- Make root AGENTS targeted-start consistent ([541472b](https://github.com/xtrm-dev/core/commit/541472b00ea46b881c891f4f3f592e35f0c13ceb))
- Reconcile root CLAUDE.md to the v4 targeted-start doctrine ([adcf540](https://github.com/xtrm-dev/core/commit/adcf54057ffadc98333c8c02688115157106a0cf))
- Skip project hook writes already covered globally (#630) ([1fda1a7](https://github.com/xtrm-dev/core/commit/1fda1a7b1ffa9a4d42452aee4838d32a064e6261))
- Stop granting bd-prime permission; drop retired serena surface (#631) ([e558412](https://github.com/xtrm-dev/core/commit/e5584126a2df7d5d42a53bf00927e1424244e5f7))
- Publish registerFooterSection on globalThis at load, clear at unload ([edc9707](https://github.com/xtrm-dev/core/commit/edc9707596479acce5d5e6fabafede26b6a2fa4f))
- Apply globally-covered guard on the sync path, pin canonical hooks (#634) ([f03c24e](https://github.com/xtrm-dev/core/commit/f03c24eba282ce4b27d4e31f5e1e40bdeb81d1c1))
- Resolve cache module from main checkout in worktrees (#638) ([25faae3](https://github.com/xtrm-dev/core/commit/25faae3eaea4786563203ac0d810d7759149c6e2))
- Bump vitest family to 4.1.11 (xtrm-6qu.8.1) ([9e3d78d](https://github.com/xtrm-dev/core/commit/9e3d78ddaa697b61cf98d5b2492934d8ef89c053))
- Wake xt claude sessions through the specialists channel (#650) ([e3c0992](https://github.com/xtrm-dev/core/commit/e3c09927f115a9ad551953ede2262c91a9bbb431))
- Pass --channels on the xt claude direct launch path (#653) ([d5cd4a6](https://github.com/xtrm-dev/core/commit/d5cd4a68561d88cbbbcd4cea570f6671a0665a1c))
- Pass --channels when xt attach resumes a Claude session (#654) ([2197709](https://github.com/xtrm-dev/core/commit/2197709d4b188dbee78363ea9a02be557cd9a4de))
- Make globally-shipped packs activatable at both scopes (xtrm-e7jzt) (#657) ([a6f20aa](https://github.com/xtrm-dev/core/commit/a6f20aa696c245be085e4c4ffc824e8f030002ea))
- Keep non-skill default-tier entries visible in global views (xtrm-lihqb) (#658) ([b8118b6](https://github.com/xtrm-dev/core/commit/b8118b6ca76982693c56aeeff8efa3d8f9e744dc))
...
- Collapse domain stacks into optional umbrellas ([34c8649](https://github.com/xtrm-dev/core/commit/34c8649ae16f883294cf568ae42cc51db84fb644))
- Promote engineering quality and causal debugging ([f49692b](https://github.com/xtrm-dev/core/commit/f49692b4943ffc44cb64c43efacc716624ddead6))
- Add causal provenance debugging ([58e747a](https://github.com/xtrm-dev/core/commit/58e747ad69f68a81ef13050bb1a8c76d15f37308))
- Add engineering review reference ([3a831f3](https://github.com/xtrm-dev/core/commit/3a831f3b6e4d546af0f466b8316278ef7b35a46c))
- Add engineering testing reference ([8692c32](https://github.com/xtrm-dev/core/commit/8692c323686d6c0707c9a5d70b90a2ed568d631c))
- Add verification reference ([c407c84](https://github.com/xtrm-dev/core/commit/c407c8434f7f9db9b7c2a589c7b1bee58e2bd3f4))
- Add engineering reduction reference ([dc8f003](https://github.com/xtrm-dev/core/commit/dc8f003ff760382af328d2e221cf0b01697ad9b0))
- Make SRE investigations causality-first ([a1605a1](https://github.com/xtrm-dev/core/commit/a1605a1138e8d611268bfbbf80ba3c67f2651072))
- Add SRE causal trace reconstruction ([4b14e54](https://github.com/xtrm-dev/core/commit/4b14e5404c5b8172d7df6447ef0cb9f316718637))
- Strengthen SRE observability triage ([f1e2adb](https://github.com/xtrm-dev/core/commit/f1e2adb5cc952117db5cacd22dec715f59e23104))
- Enrich deploy verification evidence ([f0f83de](https://github.com/xtrm-dev/core/commit/f0f83de7e8d1e938d20c1c23c1a5b2694288cf6d))
- Make incident synthesis provenance-aware ([5d5444f](https://github.com/xtrm-dev/core/commit/5d5444f064575c8a682933666643accf695645cc))
- Include engineering quality in default surface ([9d07f88](https://github.com/xtrm-dev/core/commit/9d07f88e416a946895b715064b2d880aff611c92))
- Route XTRM engineering through quality doctrine ([4c20ad7](https://github.com/xtrm-dev/core/commit/4c20ad716e15e4be819ddeb8dd41cdb2b9c827ff))
- Record causal debugging consolidation ([736a801](https://github.com/xtrm-dev/core/commit/736a801303010c58b7af1500662f3a0ef008b683))
- Remove superseded optional code-quality pack ([0f23b02](https://github.com/xtrm-dev/core/commit/0f23b02fe7e82f30f03493dca25d551fa6a0457a))
- Declare Specialists skill placement by tier and pack ([ed50527](https://github.com/xtrm-dev/core/commit/ed505272af74205e9b4a79bd1d9c073ed27bc11c))
- Route Specialists updates through maintenance pack ([c15a2f4](https://github.com/xtrm-dev/core/commit/c15a2f424b68cf89d08fd37634bdfa38c7753273))
- Record Specialists v4 release placements ([96fcb37](https://github.com/xtrm-dev/core/commit/96fcb3764201b1254840bf9ab2bfe9a810d20a6d))
- Validate Specialists ownership and pack placement ([5800181](https://github.com/xtrm-dev/core/commit/580018114c0f6afab73e0774b63bc9f9909ecfe1))
- Vendor only Specialists runtime skill payload ([5b4dbdd](https://github.com/xtrm-dev/core/commit/5b4dbddd7c90d6c56d55bc7fb5a1c64336345d27))
- Rewrite ownership around placement-aware vendoring ([01ebe22](https://github.com/xtrm-dev/core/commit/01ebe2249454c81946f436ee683bf5a239a9d7f9))
- Initialize Specialists advanced pack root ([8a9d0ef](https://github.com/xtrm-dev/core/commit/8a9d0ef22bc382081092b7e2f54ee9e1fcfea01d))
- Checkpoint v4 migration state ([109623d](https://github.com/xtrm-dev/core/commit/109623d23ce2dc7bb8b7dffa495b2adf01f800fd))
- Materialize Specialists skills at declared placements ([3999e73](https://github.com/xtrm-dev/core/commit/3999e73874615dee88513f998997d849778451a6))
- Refresh Specialists payload from pinned v4 source ([5d3ee21](https://github.com/xtrm-dev/core/commit/5d3ee213b580e17edd61178b822ead7e54cd3186))
- Use native Git blob identities for vendor provenance ([48c382a](https://github.com/xtrm-dev/core/commit/48c382a9af04da9e24637c9b04fe93b8158c0625))
- Pin placement-aware Specialists v4 runtime payload ([4a728dc](https://github.com/xtrm-dev/core/commit/4a728dc0ccd5ae512bbd48db63785f02be7f525a))
- Add strict managed skill and pack contract guard ([2dc93d1](https://github.com/xtrm-dev/core/commit/2dc93d1000372ad1159da4b018a178a85f36f5f6))
- Gate releases on managed skill contract validation ([4222b58](https://github.com/xtrm-dev/core/commit/4222b585aed07b7980f39ecf8cd36386f029d1f0))
- Gate managed skill contracts and optional vendor placement ([f02d97b](https://github.com/xtrm-dev/core/commit/f02d97b6a75de1146a90551e88ad35d9a46faf10))
- Update root budgets for universal v4 skill surface ([4ae42d9](https://github.com/xtrm-dev/core/commit/4ae42d970870122360b1268c78863f3c162b7ed0))
- Add causal debugging evals with red herrings ([293c912](https://github.com/xtrm-dev/core/commit/293c9124fdbbe8c0fd8a6405e1a4979007285111))
- Adopt topology-aware multi-signal causal reconstruction ([f6646c8](https://github.com/xtrm-dev/core/commit/f6646c8856e08516e589f13b4dedb99cedff76ba))
- Make provenance collection deterministic in causal debugging ([e4c0d50](https://github.com/xtrm-dev/core/commit/e4c0d504e2f49de16491a28c351ebc3fca4d93c9))
- Restore mcpq and service-knowledge runbook flow ([c502393](https://github.com/xtrm-dev/core/commit/c5023933990de5594164c7abf1f1d08a07137f16))
- Mirror unified Specialists execution skill ([ad81257](https://github.com/xtrm-dev/core/commit/ad81257a6e1b046a56c35f19304b50424634b1d6))
- Mirror Specialists KPI reference ([79ed7e6](https://github.com/xtrm-dev/core/commit/79ed7e61a503a656dba860f3c5f9801f29f9ca22))
- Mirror NodeSupervisor reference ([5306284](https://github.com/xtrm-dev/core/commit/5306284d32da83996177f305cc750dd01daef464))
- Mirror script-class Specialists reference ([09d3d55](https://github.com/xtrm-dev/core/commit/09d3d55db5cf40ec3d92e302f670320622b34398))
- Mirror Specialist definition reference ([1fbab31](https://github.com/xtrm-dev/core/commit/1fbab3138525ecb46fe386c86948bf9ca87f4b60))
- Mirror Specialist root resolver ([193db34](https://github.com/xtrm-dev/core/commit/193db34be553e3d7b1f8788bb0fe0781fc121445))
- Mirror Specialist validator ([2a68f2d](https://github.com/xtrm-dev/core/commit/2a68f2de09a5a5398d5cebc790ef5cecd98f5b57))
- Mirror Specialist definition audit ([84a1389](https://github.com/xtrm-dev/core/commit/84a1389db2649c688185766933a6e69fa5ae85ce))
- Mirror Specialist definition scaffold ([560c2ea](https://github.com/xtrm-dev/core/commit/560c2eafafb8d87c0ff3e172f94f9b9fd59d3ffe))
- Collapse Specialists ownership to unified surface ([03be80f](https://github.com/xtrm-dev/core/commit/03be80f1883055c1404a6719369912799a23a3a3))
- Collapse Specialists release assets ([b7c1cb8](https://github.com/xtrm-dev/core/commit/b7c1cb8df47d295f6ace72a2d32524f53299f883))
- Repin unified Specialists runtime mirror ([204b90f](https://github.com/xtrm-dev/core/commit/204b90f7045d44d02df8149d09ca82aa45cbb35b))
- Remove superseded Specialists advanced pack ([1026cd8](https://github.com/xtrm-dev/core/commit/1026cd8dcadd3bcc33b2764f7cdd1824034f2017))
- Preserve permanent board-audit export contract ([4f6950e](https://github.com/xtrm-dev/core/commit/4f6950e2201f34160a2f1a1f8f21463a7a5797ab))
- Restore distinct maintenance workflows ([6193b4d](https://github.com/xtrm-dev/core/commit/6193b4d951da1df5b317e3020b8468d190c21ec8))
- Register restored maintenance workflows ([dcc8352](https://github.com/xtrm-dev/core/commit/dcc835288e38d877f818ac3a4964d07fe91b9915))
- Slim release workflow around live gates ([8a075fa](https://github.com/xtrm-dev/core/commit/8a075fa307185f27189e9ac941d921f75ca2171c))
- Preserve bounded single-doc sync without stale hidden rule ([99594a8](https://github.com/xtrm-dev/core/commit/99594a8c1c6eeb7f39ffa9f3a646f57fde0c2200))
- Preserve dependency update workflow as optional capability ([bdf8ab3](https://github.com/xtrm-dev/core/commit/bdf8ab310cb4482cbd9435992d3300f373556bb2))
- Restore current hook development workflow ([0abb0b2](https://github.com/xtrm-dev/core/commit/0abb0b23d68f3c22d3818c3ab2f298098ba94f2b))
- Register hook development workflow ([fcae4ef](https://github.com/xtrm-dev/core/commit/fcae4efcf7aa7d42da24bad2422735191fa2238f))
- Reconcile current lifecycle and policy ownership ([d23dcc3](https://github.com/xtrm-dev/core/commit/d23dcc3cda45b8562444eda683d6566eb8a588ff))
- Preserve security bootstrap assets ([4778b7d](https://github.com/xtrm-dev/core/commit/4778b7dab8623a1030aaa40662de4c2602f0cef9))
- Register security bootstrap workflow ([3e84f3c](https://github.com/xtrm-dev/core/commit/3e84f3cabb6e92354cbb1a2e2ee7ba876d1e99b5))
- Add v4 capability preservation matrix ([548bcad](https://github.com/xtrm-dev/core/commit/548bcad0e2a14b6e155e7117d5e53258213aa2b0))
- Derive Specialists ownership checks from manifest ([d926200](https://github.com/xtrm-dev/core/commit/d926200b1b822f861b308b5e4ff477295a4f2bd6))
- Reconcile unified Specialists ownership ([7b58cc7](https://github.com/xtrm-dev/core/commit/7b58cc7e9e84e7f4965eaa6e75339a87186609dd))
- Replace stale v3 catalog with v4 tier model ([e5ba267](https://github.com/xtrm-dev/core/commit/e5ba2678940add6bfc439eaae54b2b5d6198ebea))
- Release path for python-kernel v2 — verify script (xtrm-h7uwi.4) ([f3dda80](https://github.com/xtrm-dev/core/commit/f3dda808f77055614a3f4ba579a9d35a5647d87b))
- E2e smoke for python-kernel v2 + service-knowledge v1 (xtrm-vs7f8) ([e5c9e08](https://github.com/xtrm-dev/core/commit/e5c9e082e8b422e3fe7b50d015dcfb11a383937e))
- READMEs + manifest blurbs + MIGRATION_NOTES; fix prelude-after-reset (xtrm-vs7f8) ([59b3850](https://github.com/xtrm-dev/core/commit/59b3850428fcd37900b6c454b6646566f5bcea18))
- Tool-definition audit + fix last_sync_ref vs git HEAD length mismatch (xtrm-vs7f8) ([6f180a6](https://github.com/xtrm-dev/core/commit/6f180a679970b24a421e606fd89c8dfeaa8bcfa9))
- Commit-corpus fallback doctrine in service-knowledge ext README (xtrm-6z6.3) ([d703f82](https://github.com/xtrm-dev/core/commit/d703f822666cd70cd3ebdbfe6f22cf5d38bc4dad))
- Retire service-knowledge ext — relocated to @jaggerxtrm/pi-service-knowledge (xtrm-6z6.5) ([d308478](https://github.com/xtrm-dev/core/commit/d3084781ff2cf4a2c4a04fd76dc1b359a2670ac6))
- Drop orphaned service-skills policy — unblock CI parity check ([2c48afd](https://github.com/xtrm-dev/core/commit/2c48afdfd3d1e4788d17bfe6a75b7c8a2ede76de))
- Drop dead service-skills twin suites retired by 6z6.1 ([bbde9d0](https://github.com/xtrm-dev/core/commit/bbde9d077f1bfc03a4a12f8e5321968e1f24fda5))
- Sync current main into skills-v4 branch ([7b2c807](https://github.com/xtrm-dev/core/commit/7b2c80775b337779ed459a6c6d91039ad7f357f8))
- Correct xt-merge ownership ([37fcacf](https://github.com/xtrm-dev/core/commit/37fcacf57b3d3b77eb96b6497716710e1e386d30))
- Remove stale bootstrap assumptions ([e2152b8](https://github.com/xtrm-dev/core/commit/e2152b8060351b8bc26d861034d304e3c85e3f3c))
- Repin specialists source after kpi cleanup ([d410480](https://github.com/xtrm-dev/core/commit/d41048071e5ce67187042bc2a99bdf59c00e81a3))
- Pin squashed specialists doctrine commit ([66e3be0](https://github.com/xtrm-dev/core/commit/66e3be09f6c4cf555ae040ea8be949388cecb028))
- Expose generated registry for reconciliation ([4c0c33d](https://github.com/xtrm-dev/core/commit/4c0c33d3e6b8f5740f5ae18ca3fc27f94320b7c6))
- Pin final Specialists v4 source head ([adf5fa4](https://github.com/xtrm-dev/core/commit/adf5fa4bc9505a02684ac2a10fb3b998414e06e4))
- Align ownership release pin with Specialists v4 head ([446c8a1](https://github.com/xtrm-dev/core/commit/446c8a1e526610271ddc418f29717d2e97473c52))
- Align release manifest with Specialists v4 head ([9b0fa12](https://github.com/xtrm-dev/core/commit/9b0fa12fb8eb0a2ad441a2857cebda8b31807886))
- Reconcile public guide with skills-v4 runtime ([e8a8a98](https://github.com/xtrm-dev/core/commit/e8a8a98f764770de8b97649da1e21698885aed1e))
- Final v4 reconciliation — pin e665ceed, registry, de-instrument, docs ([eea5448](https://github.com/xtrm-dev/core/commit/eea5448898e8cbcfc5f9d63bb2fab4dd64753afc))
- Bump Specialists pin to final head 6e2219ba ([2822d6d](https://github.com/xtrm-dev/core/commit/2822d6de6c2665d452321f26616eeb5fc5aa6755))
- Lead with XTRM runtime and contract model ([b114807](https://github.com/xtrm-dev/core/commit/b1148077d283816afcfa682dcf558c3e3f6eb9d4))
- Align extension package ownership ([c4f4a7e](https://github.com/xtrm-dev/core/commit/c4f4a7e78da24a64b332104a2b5ad0f183201de3))
- Cover managed npm and git package baseline ([3c50c2a](https://github.com/xtrm-dev/core/commit/3c50c2acad6e25dcd3105d40cb8d6017d11fcaa6))
- Document unified managed runtime ([aacb913](https://github.com/xtrm-dev/core/commit/aacb9133a2a2e13dddfa694bd86b7ac4c6d3dea4))
- Align install schema package baseline ([e660b75](https://github.com/xtrm-dev/core/commit/e660b75565ae6843a2da7b589a820b7ac41473a6))
- Align settings package baseline ([cf37ed5](https://github.com/xtrm-dev/core/commit/cf37ed50b88abdb7dbb28cfcbd0c9176c91cb82c))
- Align root Pi package metadata ([1e4f708](https://github.com/xtrm-dev/core/commit/1e4f708f087184079801d1400e179be7bed39f31))
- Document managed package baseline ([7332c80](https://github.com/xtrm-dev/core/commit/7332c80926eed45553b393389b4395ed662843bc))
- Make work identity core XTRM doctrine ([2e796f7](https://github.com/xtrm-dev/core/commit/2e796f7ee89f666a768715623f771139a9718fd8))
- Narrow continuity skill to re-entry ([cf81474](https://github.com/xtrm-dev/core/commit/cf814745409c5aceee5beceb9646e65978757618))
- Distinguish contracts from execution check-ins ([d92d8b2](https://github.com/xtrm-dev/core/commit/d92d8b2b835ae403ff605ededa075e17dc3ff478))
- Cover durable work lifecycle facade ([6cd9673](https://github.com/xtrm-dev/core/commit/6cd9673e489b11dda9964958b9a11c3b2c47bc10))
- Explain durable execution identity lifecycle ([54448c1](https://github.com/xtrm-dev/core/commit/54448c1e8202b77906ca703f7127d6f209c40686))
- Reflect durable work identity ownership ([306d86d](https://github.com/xtrm-dev/core/commit/306d86da3b57d756591250899b8196de9b28349f))
- Clarify work identity router ownership ([1f0a735](https://github.com/xtrm-dev/core/commit/1f0a735923432136cef9074d7411d00fcf4d2b9e))
- Retire legacy startup and tmux doctrine ([ce09ecd](https://github.com/xtrm-dev/core/commit/ce09ecdff173c7dabd6b3eaa55ad6c41ff1d4e4d))
- Point gate recovery at xt work ([053fbde](https://github.com/xtrm-dev/core/commit/053fbde3220c125b5c3cc87430da026c86f179ef))
- Document xt work gate recovery ([a0cd4e8](https://github.com/xtrm-dev/core/commit/a0cd4e88cd5b55a82a36d7e0681ed4f582e0da4c))
- Enforce receipt and claim ordering ([037ad35](https://github.com/xtrm-dev/core/commit/037ad35636d98a85286ec10caa7de0274c04d821))
- Cover xt work session lifecycle bridge ([53241f9](https://github.com/xtrm-dev/core/commit/53241f92a3e3a48281f873fb64ac1b15b3e0ebae))
- Cover Claude xt work claim sync receipts ([0ad6b14](https://github.com/xtrm-dev/core/commit/0ad6b145d0009ba2a660a81ef7fa876820e65f24))
- Park durable execution identity idea ([8da6dc0](https://github.com/xtrm-dev/core/commit/8da6dc0419ff95061ad3d35b9037ff0f58fc32d1))
- Ensure concepts directory placeholder ([2b02f33](https://github.com/xtrm-dev/core/commit/2b02f331e76f9d81049fda584bf315c7377b93a6))
- Temporary parking marker ([e535ce9](https://github.com/xtrm-dev/core/commit/e535ce90d9b60536db33280ab2322a7a1998c938))
- Refresh vendored Specialists registry reference ([9d77153](https://github.com/xtrm-dev/core/commit/9d77153dbe2660a215e62c1fda1970a40e07eaa8))
- Pin final Specialists v4 head ([69a0297](https://github.com/xtrm-dev/core/commit/69a0297da5614226647b6a8fa0016846a8edc90f))
- Align ownership manifest to final Specialists head ([80bcaa4](https://github.com/xtrm-dev/core/commit/80bcaa4d2363b2f051db8cfa9757a47877f5900b))
- Align release ownership pin to Specialists ([2faccf4](https://github.com/xtrm-dev/core/commit/2faccf4892a0af14374b393367c9db11c2feb7aa))
- Temporarily enable manual CI retry ([7672f12](https://github.com/xtrm-dev/core/commit/7672f121aef3cfddb61dc6bd68f889a63fa30ba1))
- Refresh dist after work lifecycle changes ([4ae3420](https://github.com/xtrm-dev/core/commit/4ae34200063606a9054dba9f8f89db82dfa3e5e9))
- Isolate Pi package and hook fixtures ([68cb1d9](https://github.com/xtrm-dev/core/commit/68cb1d9f57722f196375956a658553611eb80622))
- Remove temporary manual dispatch trigger ([fbce950](https://github.com/xtrm-dev/core/commit/fbce9500c01117e79a40132f229a9acf6d6d63a9))
- Reconcile ISSUE-136 with skills-v4 ([4c45a99](https://github.com/xtrm-dev/core/commit/4c45a99a810e30b04a7c827dcb0dbddcb312fa7d))
- Render v4 canonical body for Pi-neutral top ([33b7fbd](https://github.com/xtrm-dev/core/commit/33b7fbd9d539faab19a40d245a910a24eff8be40))
- Render v4 canonical body for Claude top ([371a45f](https://github.com/xtrm-dev/core/commit/371a45fbfe9fa4c32130caba7659b8713ff3c006))
- Enforce v4 canonical parity ([6494aad](https://github.com/xtrm-dev/core/commit/6494aadcda2c40b0c302689b150b89d4019c2fe3))
- Align workflow fragment with targeted skills-v4 contract ([0a57fdf](https://github.com/xtrm-dev/core/commit/0a57fdfa3dabdfbca623bae4f9a00673d91844ff))
- Reconcile architecture with skills-v4 runtime ([e6cd406](https://github.com/xtrm-dev/core/commit/e6cd40622fb68841bc1e81ca39c982f891ad782e))
- Describe XTRM as multi-agent runtime ([a4f3e40](https://github.com/xtrm-dev/core/commit/a4f3e4026e2be12cec65e25e66db948ac999e868))
- Add one-shot Core v4 finalizer ([7f38af0](https://github.com/xtrm-dev/core/commit/7f38af0680172681c8e5dbc6b79c38fa304be610))
- Run one-shot Core v4 finalizer ([a902a9c](https://github.com/xtrm-dev/core/commit/a902a9ccb3f6917d5ad2fd6f339fcc6ed80a106f))
- Restore normal Core verification workflow ([18650ba](https://github.com/xtrm-dev/core/commit/18650ba04fd91f95a55e1f97eefa3de657f8d07a))
- Remove one-shot Core v4 finalizer ([afb8602](https://github.com/xtrm-dev/core/commit/afb86021e2d42e28a566c2311ced7d4538ae6fdf))
- Stage skills-v4 deterministic finalizer ([6fd0879](https://github.com/xtrm-dev/core/commit/6fd0879ade6164b716d42384c0461b5504438c57))
- Align skills-v4 finalizer install with core CI ([b1112bb](https://github.com/xtrm-dev/core/commit/b1112bb152122ea73af6f500e4f67d43fb18ccbf))
- Fix skills-v4 instruction regeneration invocation ([ce72bc6](https://github.com/xtrm-dev/core/commit/ce72bc6c272780e1ba4778d2e939e67e649bb007))
- Verify asset contract from frozen specialists checkout ([5248060](https://github.com/xtrm-dev/core/commit/52480607050998f9810f265532e84ec84199028b))
- Parse exact contract marker lines ([38cbf73](https://github.com/xtrm-dev/core/commit/38cbf734fd1a9f6898e49e82706a04f0cbcff21c))
- Rerun skills-v4 finalizer after parity parser fix ([0a6e71c](https://github.com/xtrm-dev/core/commit/0a6e71cc428eaa99f950689e82715e222bd650fe))
- Harden hook reconciliation in skills-v4 finalizer ([c257200](https://github.com/xtrm-dev/core/commit/c25720003f288e5c40c8759d38d8afa5ffcd9b13))
- Stage one-shot hook reconciliation fix ([678810b](https://github.com/xtrm-dev/core/commit/678810b67dafc8f60b2843906a192ce4179212d5))
- Simplify skills-v4 finalizer runner ([195cafe](https://github.com/xtrm-dev/core/commit/195cafe7634df2249b42c6eda386d7561c48b1b1))
- Finalize generated payload ([8035bdd](https://github.com/xtrm-dev/core/commit/8035bdd538ac2c82b21fa4ad7c13e35b4a9da125))
- Trigger final skills-v4 verification ([b6c7b09](https://github.com/xtrm-dev/core/commit/b6c7b09579edf75e94bcf0b2680990815c066423))
- Remove final skills-v4 verification trigger ([be97076](https://github.com/xtrm-dev/core/commit/be970762ed144ca4be3686456824629a53616701))
- Capture final generated dist and registry artifacts ([a3f8431](https://github.com/xtrm-dev/core/commit/a3f843145a0791f02d2c2e5515b69669bfde9519))
- Commit deterministic generated outputs on skills-v4 branch ([2965f4a](https://github.com/xtrm-dev/core/commit/2965f4a1cb8205a9bf925bddad9ec1e0a7fa720f))
- Restore normal read-only validation workflow ([35d29ef](https://github.com/xtrm-dev/core/commit/35d29ef27ecd88b1f53e95e7fed922c53efa26e7))
- Reconcile root AGENTS targeted-start drift ([79d06e6](https://github.com/xtrm-dev/core/commit/79d06e6c948bed2755af462a475fa6eb8fefe994))
- Guard root guides against mandatory bd prime ([9db132a](https://github.com/xtrm-dev/core/commit/9db132a0ee4a37fb4e0d3b6068ef40960ef41e5c))
- Restore normal read-only validation after AGENTS reconciliation ([6461b78](https://github.com/xtrm-dev/core/commit/6461b789d0fdcf36e238f14546046648c747f820))
- Bump fast-uri from 3.1.5 to 3.1.7 ([112ec08](https://github.com/xtrm-dev/core/commit/112ec08900863be26b4fc98472c5343759f84f03))
- Rebuild dist for fast-uri 3.1.7 ([def82eb](https://github.com/xtrm-dev/core/commit/def82ebcab11a646a0d39340115daa8faf3694ff))
- Refresh managed blocks and githooks via xt update --apply ([79bb346](https://github.com/xtrm-dev/core/commit/79bb34615ee3af92c483a472cc48d8d046296bcf))
- Repin Specialists provenance to master@5d2f2907 (#626) ([8688bc3](https://github.com/xtrm-dev/core/commit/8688bc31aef05d8ddfb900cfacb6d091cddabd24))
- Present Core as XTRM's control plane (#533) ([9311288](https://github.com/xtrm-dev/core/commit/9311288e8ce58817be648795c70788eb0f335dff))
- Bump cli fast-uri 3.1.5 to 3.1.7 (#628) ([e9a11c8](https://github.com/xtrm-dev/core/commit/e9a11c8ee75458e416d1c8fc3e9f4efbdc8e57aa))
- Scan push-to-main with pre-push baseline (#629) ([b3b1578](https://github.com/xtrm-dev/core/commit/b3b1578698acdbdff590ab0d1398d19a36f0005a))
- Neutral model, color only the effort level (#635) ([0dc1d6d](https://github.com/xtrm-dev/core/commit/0dc1d6dacd1d9d341ee9e55294288aff8d3253fe))
- Retire bd-memory stack (Stop gate, doctrine, xt memory CLI) (#639) ([959c771](https://github.com/xtrm-dev/core/commit/959c77187e6e4c5395611326e2f2f7b22174803e))
- Sync operator docs to release reality (memory retirement, Exa, serena strip, global hooks, skills-v4) (#643) ([8ed4edd](https://github.com/xtrm-dev/core/commit/8ed4edddeb91c1f7a50784a352c21456939d5ef1))
- Refresh from live tree — Exa MCP, memory retirement, global-first hooks, skillbridge (#642) ([058b220](https://github.com/xtrm-dev/core/commit/058b220413eb27401b4284fe5b5433ab0377e7d6))
- Strengthen python-kernel preflight teaching (xtrm-2lxah) ([ac3286f](https://github.com/xtrm-dev/core/commit/ac3286fb961c3cb50034b52e3e26e1517ab32dfc))
- Document Substrate MCP launch env and attach additions (#659) ([de62385](https://github.com/xtrm-dev/core/commit/de62385d70dca3dd2b569ffcb188d8f586dc8547))
