...
CONTRACT_PATH = Path(__file__).resolve().parents[2] / "creating-service-skills" / "references" / "service_skill_contract.json"
...
def main() -> None:
    ...
    if len(args) != 1:
        ...
        sys.exit(1)
    sys.exit(0 if migrate_skill_file(Path(args[0])) else 0)
