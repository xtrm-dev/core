...
const allowlist = new Map([
  ...
  // Lane 2 (hook cleanup): the 11 retired beads payloads are deleted,
  // so no beads entries remain. Exact paths only — no globs, no broad
  // exemption — so any future unmanaged file still fails this check.
]);
